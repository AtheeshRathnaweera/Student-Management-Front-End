...
package com.microsoft.azure.msalwebsample.controllers;
...
import com.microsoft.azure.msalwebsample.helpers.HttpClientHelper;
...
public class AuthPageController {
    ...
    @RequestMapping("/studentmanagement/index")
    public String homepage(){
        return "index";
    }

    @RequestMapping("/studentmanagement/secure/aad")
    ...
    @RequestMapping("/studentmanagement/sign_out")
    public void signOut(HttpServletRequest httpRequest, HttpServletResponse response) throws IOException {
        ...
        String redirectUrl = "https://localhost:8443/studentmanagement/";
        response.sendRedirect(endSessionEndpoint + "?post_logout_redirect_uri=" +
                URLEncoder.encode(redirectUrl, "UTF-8"));
    }

    @RequestMapping("/studentmanagement/graph/me")
